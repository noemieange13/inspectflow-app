...
-- Used by ensureReportPayloadHtml so PDF prep cannot wipe concurrent cover/content/notes saves
-- via a stale full-payload replace after async clause loading.
